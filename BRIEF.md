...
- The page background MUST remain white. Do not use the theme `--background` green as the site/page background.
- Use Fresh Greens primarily for text, borders, icons, links, buttons, and accents.
...
- Use the Lovable Fresh Greens tokens from the Visual Direction section, but keep the page background white.
